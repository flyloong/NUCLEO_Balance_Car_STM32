...
//#define FIFO_CS_H()     GPIOA->BSRR =GPIO_PIN_13	  
//#define FIFO_CS_L()     GPIOA->BRR  =GPIO_PIN_13	  /*拉低使FIFO输出使能*/

#define FIFO_WRST_H()   GPIOB->BSRR =GPIO_PIN_14	  /*拉高允许FIFO写(数据from摄像头)指针运动 */
#define FIFO_WRST_L()   GPIOB->BSRR =GPIO_PIN_14<<16  /*拉低使FIFO写(数据from摄像头)指针复位*/

#define FIFO_RRST_H()   GPIOA->BSRR =GPIO_PIN_3	  /*拉高允许FIFO读(数据从FIFO输出)指针运动 */
#define FIFO_RRST_L()   GPIOA->BSRR =GPIO_PIN_3<<16		  /*拉低使FIFO读(数据从FIFO输出)指针复位 */

#define FIFO_RCLK_H()   GPIOC->BSRR =GPIO_PIN_4	  
#define FIFO_RCLK_L()   GPIOC->BSRR =GPIO_PIN_4<<16		  /*FIFO输出数据时钟*/

#define FIFO_WE_H()     GPIOB->BSRR =GPIO_PIN_15	  /*拉高使FIFO写允许*/
#define FIFO_WE_L()     GPIOB->BSRR =GPIO_PIN_15<<16
